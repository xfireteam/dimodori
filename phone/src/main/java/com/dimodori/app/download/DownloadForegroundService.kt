...
class DownloadForegroundService : Service() {
    ...
    companion object {
        private const val ACTION_START = "com.dimodori.app.download.FGS_START"
        private const val ACTION_STOP = "com.dimodori.app.download.FGS_STOP"
